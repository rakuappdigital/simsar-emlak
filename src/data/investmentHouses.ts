...
export const investmentHouses: HouseScene[] = [
  {
    ...
    nodes: {
      ...
      detay: {
        id: "detay",
        lines: [{ speaker: "customer1", text: "Peki fiyatta biraz esneklik olur mu?" }],
        choices: [
          { id: "a", text: "\"Bu fiyat gayet net, bu değerin altına inmem.\"", next: "closing", effects: { suspicion: 5 } },
          { id: "b", text: "\"Makul bir teklifle konuşabiliriz.\"", next: "closing", effects: { interest: 10, fun: 5 } },
          { id: "c", text: "\"Küçük bir esneklik olabilir, ama fazla değil.\"", next: "closing", effects: { interest: 5, discountPercent: 3 } },
        ],
      },
      closing: {
        id: "closing",
        ...
        choices: [
          ...
          { id: "b", text: "\"Acele etmenize gerek yok, düşünün.\"", next: "", effects: { closingBias: -10, fun: 5 } },
        ],
      },
...

  {
    ...
    nodes: {
      ...
      detay: {
        ...
        lines: [{ speaker: "customer1", text: "Peki fiyatta biraz esneklik olur mu?" }],
        choices: [
          { id: "a", text: "\"Bu fiyat net, altına inmem.\"", next: "closing", effects: { suspicion: 5 } },
      ...
      closing: {
        id: "closing",
        lines: [{ speaker: "customer1", text: "Karar vermem lazım sanırım." }],
        choices: [
          { id: "a", text: "\"Bu şartlarla anlaşalım.\"", next: "", effects: { closingBias: 15 } },
          { id: "b", text: "\"Acele etmeyin, düşünün.\"", next: "", effects: { closingBias: -10, fun: 5 } },
        ],
      },
    ...
    nodes: {
      ...
      detay: {
        ...
        choices: [
          ...
          { id: "c", text: "\"Küçük bir esneklik olabilir.\"", next: "closing", effects: { interest: 5, discountPercent: 3 } },
        ],
      },
      closing: {
        id: "closing",
...

  {
    ...
    nodes: {
      ...
      detay: {
        ...
        lines: [{ speaker: "customer1", text: "Peki fiyatta biraz esneklik olur mu?" }],
        choices: [
          { id: "a", text: "\"Bu fiyat net, tarihi doku bu fiyatı hak ediyor.\"", next: "closing", effects: { suspicion: 5 } },
          { id: "b", text: "\"Makul bir teklif getirin, konuşuruz.\"", next: "closing", effects: { interest: 10, fun: 5 } },
          { id: "c", text: "\"Ufak bir esneklik olabilir.\"", next: "closing", effects: { interest: 5, discountPercent: 3 } },
        ],
      },
...

  {
    ...
    nodes: {
      ...
      detay: {
        ...
        lines: [{ speaker: "customer1", text: "Peki fiyatta biraz esneklik olur mu?" }],
        choices: [
          { id: "a", text: "\"Bu fiyat net, sessizlik bu fiyatı hak ediyor.\"", next: "closing", effects: { suspicion: 5 } },
          { id: "b", text: "\"Makul bir teklifle konuşabiliriz.\"", next: "closing", effects: { interest: 10, fun: 5 } },
          { id: "c", text: "\"Küçük bir esneklik olabilir.\"", next: "closing", effects: { interest: 5, discountPercent: 3 } },
        ],
      },
...

  {
    ...
    nodes: {
      ...
      detay: {
        ...
        lines: [{ speaker: "customer1", text: "Peki fiyatta biraz esneklik olur mu?" }],
        choices: [
          { id: "a", text: "\"Bu fiyat net, konum bu fiyatı hak ediyor.\"", next: "closing", effects: { suspicion: 5 } },
          { id: "b", text: "\"Makul bir teklifle konuşabiliriz.\"", next: "closing", effects: { interest: 10, fun: 5 } },
          { id: "c", text: "\"Ufak bir esneklik olabilir.\"", next: "closing", effects: { interest: 5, discountPercent: 3 } },
        ],
      },
...

  {
    ...
    nodes: {
      ...
      detay: {
        ...
        lines: [{ speaker: "customer1", text: "Peki fiyatta biraz esneklik olur mu?" }],
        choices: [
          { id: "a", text: "\"Bu fiyat net, marina manzarası bu fiyatı hak ediyor.\"", next: "closing", effects: { suspicion: 5 } },
          { id: "b", text: "\"Makul bir teklifle konuşabiliriz.\"", next: "closing", effects: { interest: 10, fun: 5 } },
          { id: "c", text: "\"Küçük bir esneklik olabilir.\"", next: "closing", effects: { interest: 5, discountPercent: 3 } },
        ],
      },
...

  {
    ...
    nodes: {
      ...
      detay: {
        ...
        lines: [{ speaker: "customer1", text: "Peki fiyatta biraz esneklik olur mu?" }],
        choices: [
          { id: "a", text: "\"Bu fiyat net, tarihi manzara bu fiyatı hak ediyor.\"", next: "closing", effects: { suspicion: 5 } },
          { id: "b", text: "\"Makul bir teklifle konuşabiliriz.\"", next: "closing", effects: { interest: 10, fun: 5 } },
          { id: "c", text: "\"Küçük bir esneklik olabilir.\"", next: "closing", effects: { interest: 5, discountPercent: 3 } },
        ],
      },
